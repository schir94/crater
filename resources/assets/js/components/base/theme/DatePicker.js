export default {
  ...
  baseColorClass: 'placeholder-gray-400 border-gray-200 focus:border-primary-500',
  invalidClass: 'border-red',
  disabledClass: 'bg-gray-200 text-gray-500',
  calendarIconStyle: 'absolute w-4 h-5 text-sm not-italic font-black cursor-pointer text-gray-400',
}
